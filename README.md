...
- Secondary fallback command-line load/unload scripts using .NET Core for crossplatform usage (wishlist) - ([see here](https://www.codementor.io/@jim_ej/working-cross-platform-with-net-core-kbv9sin1t) for some advice on making this); could also consider using [MAUI](https://github.com/dotnet/maui) for it (no official Linux support though).
